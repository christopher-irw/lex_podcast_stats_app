...
def data_analysis():
  ...
  with siteHeader:
    ...
    decided to create a clustering of the episodes based on the text
    transcripts.
    After downloading the data, I started doing some analysis and
    realised that there were a few interesting statistics about 
    the episodes. Thus, I decided to create this set of widgets to
    have a look at the insights of each episode.
